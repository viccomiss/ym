    ...
    if ([super initWithFrame:frame]) {
        ...
        for (int i=0; i<imageNameArray.count; i++) {
            ...
            if (i == imageNameArray.count-1 && isHidden == NO) {
                ...
                UIButton *startButton = [[UIButton alloc]initWithFrame:CGRectMake(DDScreenW*0.2, DDScreenH*0.85, DDScreenW*0.6, AdaptY(50))];
                [startButton setTitle:@"立即体验" forState:UIControlStateNormal];
                [startButton setTitleColor:RGBColor(208, 154, 103) forState:UIControlStateNormal];
                [startButton.titleLabel setFont:[UIFont systemFontOfSize:16]];
                ViewBorderRadius(startButton, AdaptX(4), 0.5, RGBColor(208, 154, 103));
                [startButton setBackgroundColor:[RGBColor(134, 100, 69) colorWithAlphaComponent:0.3]];
