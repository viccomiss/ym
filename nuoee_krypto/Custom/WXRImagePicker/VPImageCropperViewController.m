...
- (void)initView {
    self.showImgView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, MAINSCREEN_WIDTH, MAINSCREEN_HEIGHT)];
    ...
    self.ratioView.layer.borderColor = MainYellowColor.CGColor;
...
- (void)initControlBtn {
    UIButton *cancelBtn = [[UIButton alloc] initWithFrame:CGRectMake(0, self.view.frame.size.height - 50 * SCALE_HEIGHT, 100 *SCALE_WIDTH, 50 * SCALE_HEIGHT)];
    ...
    UIButton *confirmBtn = [[UIButton alloc] initWithFrame:CGRectMake(self.view.frame.size.width - 100 * SCALE_WIDTH, self.view.frame.size.height - 50 * SCALE_HEIGHT, 100 * SCALE_WIDTH, 50 * SCALE_HEIGHT)];
    confirmBtn.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.6];
...
-(UIImage *)getSubImage{
    ...
    NSLog(@"%@",NSStringFromCGRect(self.cropFrame));
