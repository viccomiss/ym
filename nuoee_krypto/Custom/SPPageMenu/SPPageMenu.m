...
- (void)initialize {
    ...
    functionButton.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.3];
    [functionButton setImage:[UIImage imageNamed:@"tag_menu"] forState:UIControlStateNormal];
...
//    shadowLine.backgroundColor = [UIColor blackColor].CGColor;
//    shadowLine.shadowColor = [UIColor blackColor].CGColor;
//    shadowLine.shadowOffset = CGSizeMake(5, 5);
//    shadowLine.shadowRadius = 10;
...
- (void)layoutSubviews {
    ...
    [self.functionButton.layer insertSublayer:[UIColor setGradualChangingColor:self.functionButton fromColor:[UIColor clearColor] toColor:[UIColor blackColor]] below:self.functionButton.imageView.layer];
    ...
    CGFloat itemScrollViewW = self.showFuntionButton ? backgroundViewW-functionButtonW + 5: backgroundViewW;
