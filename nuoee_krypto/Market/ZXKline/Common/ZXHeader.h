...
//k线图边框距离画布上下左右距离
//横屏的时候顶部设置距离为40;项目需求
#define TopMargin 5  //(Portrait?5:40)
#define MumTopMargin (Portrait?0:HAdaptY(50))
 ...
 */
#define LandScapeChartHeight (KSCREEN_WIDTH-TopMargin-BottomMargin-TimeViewHeight-MiddleBlankSpace-MumTopMargin)
/**
 * 高度比率
 */
 ...
 */
#define TotalHeight (Portrait ? ((ZX_IS_IPHONE_X?(KSCREEN_HEIGHT - NavbarH - AdaptY(146 + 36) - 30):(KSCREEN_HEIGHT - NavbarH - AdaptY(146 + 36)))) : (KSCREEN_WIDTH - MumTopMargin))
...
//k线图中是否需要显示股票名和M1...
#define IsDisplayStockOrQuotaName  YES
